            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input v-model="form.title_t" type="text" name="title" placeholder="title" class="form-control" :class="{ 'is-invalid': form.errors.has('title') }" disabled>
                    ...
                    <div style="display:block">
                     ...
                     <div class="form-group">
                        <input v-model="form.itemid" type="text" name="itemid" id="itemid" ref="itemid" placeholder="itemid" class="form-control" :class="{ 'is-invalid': form.errors.has('itemid') }">
                        <has-error :form="form" field="itemid"></has-error>
                    </div>

                    
                        <div class="form-group">
                            <input v-model="form.price_n" type="text" name="price_n" placeholder="price_n" class="form-control" :class="{ 'is-invalid': form.errors.has('price_n') }">
                            <has-error :form="form" field="price_n"></has-error>
                        </div>
                        <div class="form-group">
                            <input v-model="form.status_id_n" type="text" name="status_id" placeholder="status_id_n" class="form-control" :class="{ 'is-invalid': form.errors.has('status_id_n') }">
                    ...
                    <small v-show="loading == true" class="badge badge-success"><i class="fa fa-clock"></i> Loading...</small>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      unassignedtasks:[], value:'', events: [],location:'',
      //location2:'',  
      ...
      config: {          
        ...
        defaultView: "month",
        editable: true, droppable: true, eventLimit: true, nowIndicator: true,
        slotDuration: "01:00:00",slotLabelInterval: "01:00:00",
        height: "auto", contentHeight: "auto", slotLabelFormat: "LT",
        allDayText: "All Day Events", //allDaySlot: false,
        //////////////////////////////////////////////////////////////////////
  ...
  methods: { 
    ...
    onEventReceive(date, jsEvent, resource){
      ...
      //console.log(this.form.title_t)
      //console.log(date.className[0].title)    
    },
