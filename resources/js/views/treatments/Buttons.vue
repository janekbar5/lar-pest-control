...
module.exports = {
  ...
  data: function () {   
    return {         
      modelSettings: {
        modelPlural: 'treatments', modelSingular: 'treatment', 
        urlList:'/treatments',
        urlCreate:'/treatments/create',
        urlEdit:'/treatments/',
        apiList:'/v1/api/treatments/index',
        apiCreate:'/v1/api/treatments/create',
        apiEdit:'/v1/api/treatments/edit/',       
        apiUpdate:'/v1/api/treatments/update/',     
        apiDelete:'/v1/api/treatments/delete/'
      },
