...
module.exports = {
  ...
  data: function () {   
    return {     
      modelSettings: {
        modelPlural: 'roles', modelSingular: 'role', 
        urlList:'/roles',
        urlCreate:'/roles/create',
        urlEdit:'/roles/',

        apiList:'/v1/api/roles/index',
        apiCreate:'/v1/api/roles/create',
        apiEdit:'/v1/api/roles/edit/',       
        apiUpdate:'/v1/api/roles/update/',     
        apiDelete:'/v1/api/roles/delete/'
      },
