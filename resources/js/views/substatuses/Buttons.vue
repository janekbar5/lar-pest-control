...
module.exports = {
  ...
  data: function () {   
    return {         
      modelSettings: {
        modelPlural: 'substatuses', modelSingular: 'substatus', 
        urlList:'/substatuses',
        urlCreate:'/substatuses/create',
        urlEdit:'/substatuses/',
        apiList:'/v1/api/substatuses/index',
        apiCreate:'/v1/api/substatuses/create',
        apiEdit:'/v1/api/substatuses/edit/',       
        apiUpdate:'/v1/api/substatuses/update/',     
        apiDelete:'/v1/api/substatuses/delete/'
      },
