                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <label>Status Title</label>
                                            <select v-model="form.status_id" class="form-control" :class="{ 'is-invalid': errors.status_id}" disabled>
                                            <option value="">Select Parent Status</option>
                                            <option v-for="status in allstatuses" :value="status.id">
                                                {{status.title}}
                                            </option>
                                            </select>                                        
                                ...
                                <div class="col-md-4">                                    
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.description" type="text" name="description" class="form-control" disabled>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            setData(res) {
                ...
                this.show = true
                this.allstatuses = res.data.allstatuses.data //assigned roles   
