...
module.exports = {
  ...
  data: function () {   
    return {         
      modelSettings: {
        modelPlural: 'globalsettings', modelSingular: 'globalsetting', 
        urlList:'/statuses',
        urlCreate:'/statuses/create',
        urlEdit:'/statuses/',
        apiList:'/v1/api/statuses/index',
        apiCreate:'/v1/api/statuses/create',
        apiEdit:'/v1/api/statuses/edit/',       
        apiUpdate:'/v1/api/statuses/update/',     
        apiDelete:'/v1/api/statuses/delete/'
      },
